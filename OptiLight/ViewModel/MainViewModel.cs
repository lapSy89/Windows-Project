    ...
    public class MainViewModel : BaseViewModel {
        ...
        public MainViewModel() : base() {
            ...
            Lamps = new ObservableCollection<LampViewModel>() {
                 new RoundLampViewModel(new RoundLamp(50, 50) { X = 50, Y = 50, Width = 50, Height = 50, Radius = -20}),
                 new RectangleLampViewModel(new RectangleLamp(50, 50) { X = 100, Y = 50, Width = 50, Height = 50 }),
                 new SquareLampViewModel(new SquareLamp(50, 50) { X = 200, Y = 100, Width = 50, Height = 50})
            };
